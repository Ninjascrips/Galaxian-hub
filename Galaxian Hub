...
local Window = OrionLib:MakeWindow({Name = "Galaxian Hub", HidePremium = false, IntroText = "", SaveConfig = true, ConfigFolder = "Sla Hub"})

OrionLib:MakeNotification({
	Name = "Galaxian Hub",
	Content = "Choose Teams Bro?",
	Image = "rbxassetid://90592012634846",
	Time = 7
})

OrionLib:MakeNotification({
	Name = "Sla Hub",
	Content = "Galaxian Hub",
	Image = "rbxassetid://90592012634846",
	Time = 25
})
...
local W = Window:MakeTab({
    Name = "Welcome",
    Icon = "rbxassetid://90592012634846",
    PremiumOnly = false
})
...
W:AddLabel("[+] Galaxian Hub is HERE!")
